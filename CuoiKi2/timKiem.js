...
class thucDon{
    ...
    constructor(){
        this.#danhSachMon = [
            new monAn("Phở Bò", 40000, "#"),
            new monAn("Bún Chả", 35000, "#"),
            new monAn("Bánh Mì", 20000, "#"),
            new monAn("Chả Giò", 25000, "#"),
            new monAn("Bún đậu mắm tôm", 30000, "#"),
            new monAn("Nem nướng Nha Trang", 25000, "#")
        ];
        this.#gioHang = [];
        this.taiLaiGioHang();
    }
